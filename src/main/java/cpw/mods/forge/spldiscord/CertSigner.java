...
public class CertSigner {
    ...
    static InputStream signCSR(InputStream attachment) {
        ...
        String derString;
        try {
            try (BufferedReader br = new BufferedReader(new InputStreamReader(attachment, StandardCharsets.US_ASCII))) {
        ...
        } catch (IOException | SignatureException | NoSuchAlgorithmException | CertificateException | InvalidKeyException e) {
            throw new RuntimeException(e);
        }
    }
